...
public final class Moment extends JsObject {
    ...
    public static final String dddd = "dddd"; // Day of week (NOTE: these formats only make sense when combined with
                                              // "ww")
    public static final String e = "e"; // Day of week(locale) (NOTE: these formats only make sense when combined with
                                        // "ww")
    public static final String E = "E"; // Day of week(locale) (NOTE: these formats only make sense when combined with
                                        // "WW")
    public static final String w = "w"; // Week of the year (NOTE: combine this format with "gg" or "gggg" instead of
                                        // "YY" or "YYYY")
    public static final String ww = "ww"; // Week of the year (NOTE: combine this format with "gg" or "gggg" instead of
                                          // "YY" or "YYYY")
    public static final String W = "W"; // Week of the year (ISO) (NOTE: combine this format with "GG" or "GGGG" instead
                                        // of "YY" or "YYYY")
    public static final String WW = "WW"; // Week of the year (ISO) (NOTE: combine this format with "GG" or "GGGG"
                                          // instead of "YY" or "YYYY")
    ...
    public static final String GG = "gggg"; // 2 digit week year (ISO) (if greater than 68 will return 1900's, otherwise
                                            // 2000's)
    public static final String GGGG = "GGGG"; // 2 digit week year (ISO) (if greater than 68 will return 1900's,
                                              // otherwise 2000's)
    ...
    public native Moment startOf( String value )/*-{
		...
		return @com.ait.toolkit.moment.client.Moment::new(Lcom/google/gwt/core/client/JavaScriptObject;)(o);
    }-*/;
    ...
    public native int diff( String value )/*-{
		var peer = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		return peer.diff(value);
    }-*/;

    public native int diff( String value, boolean isFloating )/*-{
		var peer = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		return peer.diff(value, isFloating);
    }-*/;

    public native int diff( int value )/*-{
		var peer = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		return peer.diff(value);
    }-*/;

    public native int diff( int value, boolean isFloating )/*-{
		var peer = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		return peer.diff(value, isFloating);
    }-*/;

    public native int diff( JsDate value )/*-{
		var peer = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		return peer.diff(value);
    }-*/;
